...
gameWindow = pygame.display.set_mode(
    (screen_width, screen_height))   # Set screen width and height

# Put a logo on wellcome screen
logo = pygame.image.load('Snake_icon.png')
logo = pygame.transform.scale(
    logo, (screen_width/4, screen_height/4)).convert_alpha()
...
def gameloop():
    ...
    while not Exit_game:
        ...
        if Game_Over:
            ...
            text_screen2("Score :  " + str(score) +
                         "   ( High Score :  " + str(highScore) + ")", "blue", 350, 300)
